...
SOLVER="${CADICAL_SOLVER_BIN:-$PROJECT_ROOT/cadical/build/cadical}"
CNF_DIR="$PROJECT_ROOT/benchmarks/cnf"
OUTPUT_CSV="$PROJECT_ROOT/results_cadical.csv"
...
echo "Starting CaDiCaL benchmark (timeout=${TIMEOUT_SEC}s) on ${#files[@]} files..."
